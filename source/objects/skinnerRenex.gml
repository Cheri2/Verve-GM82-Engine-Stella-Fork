...
if (spike!="") {
    ...
    ")
        with (SpikeDown) {sprite_index=other.s_d image_blend=other.blend image_alpha=other.alpha}
    with (SpikeLeft) {sprite_index=other.s_l image_blend=other.blend image_alpha=other.alpha}
    with (SpikeRight) {sprite_index=other.s_r image_blend=other.blend image_alpha=other.alpha}
    with (SpikeUp) {sprite_index=other.s_u image_blend=other.blend image_alpha=other.alpha}
}
if (minispike!="") {
    execute_string("
        m_d=sprMiniSpikeDown"+spike+"
        m_l=sprMiniSpikeLeft"+spike+"
        m_r=sprMiniSpikeRight"+spike+"
        m_u=sprMiniSpikeUp"+spike+"
    ")
    with (MiniSpikeDown) {sprite_index=other.m_d image_blend=other.blend image_alpha=other.alpha}
    with (MiniSpikeLeft) {sprite_index=other.m_l image_blend=other.blend image_alpha=other.alpha}
    with (MiniSpikeRight) {sprite_index=other.m_r image_blend=other.blend image_alpha=other.alpha}
    with (MiniSpikeUp) {sprite_index=other.m_u image_blend=other.blend image_alpha=other.alpha}
}
